      ...
      <div>
        <div>
          ...
          <div className='mt-[30px]'>
            <h1 className='mb-[20px] text-[20px] font-semibold'>Available Option's:</h1>
            <div className='grid grid-cols-2 xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-4 sm:grid-cols-2 justify-between gap-5'>
              <div className='p-3 mr-5 bg-gray-700/30 shadow-2xl rounded hover:bg-gray-700/90 '>
                <h2 className='text-[16px] font-semibold'>Emergency Department</h2>
                <p>Available Beds: 9</p>
              </div>
              <div className='p-3 mr-5 bg-gray-700/30 rounded shadow-2xl hover:bg-gray-700/90 '>
                <h2 className='text-[16px] font-semibold'>Surgery Department</h2>
                <p>Available Beds: 18</p>
              </div>
              <div className='p-3 mr-5 bg-gray-700/30 rounded shadow-2xl hover:bg-gray-700/90 '>
                <h2 className='text-[16px] font-semibold'>Intensive Care Unit (ICU)</h2>
                <p>Available Beds: 5</p>
              </div>
              <div className='p-3 mr-5 bg-gray-700/30 rounded shadow-2xl hover:bg-gray-700/90 '>
                <h2 className='text-[16px] font-semibold'>Neurology Department</h2>
                <p>Available Beds: 11</p>
              </div>
              <div className='p-3 mr-5 bg-gray-700/30 rounded shadow-2xl hover:bg-gray-700/90 '>
                <h2 className='text-[16px] font-semibold'>Rehabilitation Department</h2>
