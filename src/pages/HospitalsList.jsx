    ...
    <div className='mt-[100px]'>
      <div className='container flex justify-center gap-1 mb-[100px]'>
        <input
          ...
          className=' bg-gray-400/30 outline-none w-[500px] px-[20px] py-[8px] rounded-l-[40px]'
        />
        <button className='px-[25px] text-[18px] font-semibold py-[8px] rounded-r-[40px] bg-black/50'>
          Search
        </button>
      </div>
