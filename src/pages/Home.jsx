            ...
            <div>
              <div className='lg:w-[570px]'>
                ...
                <h1 className=' text-[35px] mb-[10px] leading-[40px] text-gray-100 font-[700] md:text-[50px] md:leading-[55px]'>
                  ...
                  open seats effortlessly
                </h1>
                <p className='text--para mt-[20px]'>
                  Discover available spaces effortlessly with SpotSail, offering real-time updates
                  on vacant seats in restaurants, colleges, and hospitals, ensuring you always find
                  the perfect spot.
                </p>
                <div className='flex gap-4 mt-[30px]'>
                  <button className='border py-2 rounded w-[170px]'>GitHub</button>
                  <Link to='/list-your-industry'>
                    <button className='border py-2 rounded w-[170px]'>List your industry</button>
                  </Link>
                </div>
              </div>
