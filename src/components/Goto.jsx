      ...
      <div>
        <div>
          ...
          <div className='grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-3 h-[450px] mt-[30px]'>
            ...
            <Link to='/hotels-list' className='box2 cursor-pointer ease-in-out duration-300'>
              <div>
                <button className='w-[120px] shadow-[inset_0px_1px_48px_0px_#1a202c] py-2 font-bold'>
                  Hostels
                </button>
            ...
            <Link to='/restaurants-list' className='box3 cursor-pointer ease-in-out duration-300'>
              <div>
                <button className='w-[120px] shadow-[inset_0px_1px_48px_0px_#1a202c] py-2 font-bold'>
                  Restaurants
                </button>
