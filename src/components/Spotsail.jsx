          ...
          <div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-5 mt-[50px] text-[15px] ">
              <div className="p-3 text-[14px] px-[20px] rounded-[30px] bg-gray-700/30 shadow-[inset_0px_20px_20px_10px_#00000024]">
                <p>
                  Spotsail revolutionizes the way we navigate our daily lives by
                  offering a comprehensive platform that seamlessly connects
                  users with real-time information on available seating across
                  diverse establishments.
                </p>
              </div>
              <div className="p-3 text-[14px] px-[20px] rounded-[30px] bg-gray-700/30 shadow-[inset_0px_20px_20px_10px_#00000024]">
                <p>
                  Spotsail empowers you with instant access to data on vacant
                  seats in restaurants, colleges, hospitals, and hotels. Say
                  goodbye to uncertainty and hello to a world where the perfect
                  seat is just a click away with Spotsail.
                </p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-4 sm:grid-cols-2 gap-5 ">
                ...
                <Link to="/log-in">
                  <div className="shadow-[inset_0px_0px_20px_10px_#00000024] p-4 rounded cursor-pointer">
                    ...
                    <div>
                      <h3 className="text-[18px] mb-3 font-bold">
                        Login/SignUp
                      </h3>
                    </div>
                    <div>
                      <p className="text-[14px]">
                        Start by creating a Spotsail account or logging in if
                ...
                <Link to="/log-in">
                  <div className="shadow-[inset_0px_0px_20px_10px_#00000024] p-4 rounded cursor-pointer">
                    ...
                    <p className="text-[14px]">
                      Choose your preferred location and select the relevant
                      category (restaurant, college, hospital, hotel).
                    </p>
                  </div>
                </Link>
                ...
                <Link to="/log-in">
                  <div className="shadow-[inset_0px_0px_20px_10px_#00000024] p-4 rounded cursor-pointer">
                    ...
                    <p className="text-[14px]">
                      Check the real-time availability of vacant seats in your
                ...
                <Link to="/log-in">
                  <div className="p-4 rounded shadow-[inset_0px_0px_20px_10px_#00000024] cursor-pointer">
                    ...
                    <p className="text-[14px]">
                      Reserve your spot on the app, get a confirmation with
                      detail, and enjoy a hassle-free Spotsail experience!
                    </p>
                  </div>
                </Link>
